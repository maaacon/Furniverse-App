...
class AddMaterialWidget extends StatefulWidget {
  const AddMaterialWidget({super.key});

  @override
  State<AddMaterialWidget> createState() => _AddMaterialWidgetState();
}

class _AddMaterialWidgetState extends State<AddMaterialWidget> {
  ...
  saveproduct(BuildContext context) async {
    ...
    await materialService.addMaterials(materialData);
